...
class StudiosControllerTest < ActionController::TestCase
  ...
  test "should create studio" do
    assert_difference('Studio.count') do
      post :create, studio: { description: @studio.description, location: @studio.location, owner: @studio.owner, price: @studio.price }
    end
  ...
  test "should update studio" do
    patch :update, id: @studio, studio: { description: @studio.description, location: @studio.location, owner: @studio.owner, price: @studio.price }
    assert_redirected_to studio_path(assigns(:studio))
  end
